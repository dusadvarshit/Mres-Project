...
% This is simulation of drug allopurinol and constructing MFG thereafter.
clear all;
...
for i =1:length(all_models)
    ...
    model1 = changeRxnBounds(model,model.rxns(157),0,'b'); % Knockout of xanthine oxidase
    model1 = changeRxnBounds(model,model.rxns(1012),0,'b'); % Knockout of xanthine oxidase, peroxisomal
